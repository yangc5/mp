    ...
    <div class="body-content">
        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <p>Follow along with our tutorial series at Tuts+ as we build Meeting Planner step by step. In this episode we talk about startups in general and the goals for our application.</p>

                <p><a class="btn btn-default" href="http://code.tutsplus.com/tutorials/building-your-startup-with-php-getting-started--cms-21948">Episode 1 &raquo;</a></p>
            </div>
            <div class="col-lg-4">
