...
namespace app\frontend\common\models;
...
class Meeting extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            'id' => Yii::t('mp\frontend\common', 'ID'),
            'owner_id' => Yii::t('mp\frontend\common', 'Owner ID'),
            'meeting_type' => Yii::t('mp\frontend\common', 'Meeting Type'),
            'message' => Yii::t('mp\frontend\common', 'Message'),
            'status' => Yii::t('mp\frontend\common', 'Status'),
            'created_at' => Yii::t('mp\frontend\common', 'Created At'),
            'updated_at' => Yii::t('mp\frontend\common', 'Updated At'),
        ];
    }
